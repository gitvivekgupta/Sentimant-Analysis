...
#------------------
        ...
        processed_text = neutral_emoji.sub(r' EMO_NEU ', processed_text)
...
pos_vocab_file = 'pos_features.txt'

neg_vocab_file = 'neg_features.txt'

neu_vocab_file = 'neu_features.txt'


divide = 2
pos_tokens = []

with open('test.json') as json_data_test:
...
for text in e:
    ...
    try:
        ...
        with open(pos_vocab_file, "r") as pos_features:
            for pos_token in tokens:
                sent_token = pos_token
                for pos_feature_word in pos_features.readlines():
                    feature_token = pos_feature_word.strip()
                    if sent_token == feature_token:
                        print sent_token
